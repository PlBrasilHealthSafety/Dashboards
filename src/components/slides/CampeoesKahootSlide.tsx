    ...
    <div className="w-full h-full min-h-screen bg-gradient-to-bl from-[#1D3C44] via-[#0B5C5B] to-[#00A298] text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col h-full min-h-screen p-4 md:p-8">
        ...
        <div className="text-center mb-5 flex-shrink-0">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-extrabold mb-4 bg-gradient-to-r from-yellow-100 via-yellow-200 to-yellow-100 bg-clip-text text-transparent">
          ...
          <div className="w-full max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-stretch">
            ...
            <div className="bg-white/15 backdrop-blur-lg rounded-2xl p-5 md:p-7 border border-amber-400/30 shadow-2xl relative flex flex-col">
              ...
              <div className="text-center pt-4 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <div className="mx-auto mb-5 w-28 h-28 md:w-36 md:h-36 lg:w-40 lg:h-40 rounded-full border-3 border-amber-400/50 shadow-xl overflow-hidden bg-gradient-to-br from-amber-300 to-amber-500">
                    <img 
                  ...
                  <p className="text-base md:text-lg lg:text-xl opacity-90 font-light text-white/90 mb-5">
                ...
                <div className="bg-amber-400/20 rounded-xl p-4 border border-amber-400/30">
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <span className="text-base md:text-lg lg:text-xl font-semibold">Primeira Campeã!</span>
                    <Star className="w-5 h-5 text-amber-400 fill-current" />
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-5 md:p-7 border border-white/20 shadow-2xl relative overflow-hidden flex flex-col">
              ...
              <div className="text-center pt-4 relative z-10 flex-1 flex flex-col justify-between">
                <div>
                  {/* Silhueta mistério */}
                  <div className="mx-auto mb-5 w-24 h-24 md:w-32 md:h-32 lg:w-36 lg:h-36 bg-gradient-to-br from-gray-400/30 to-gray-600/30 rounded-full flex items-center justify-center border-3 border-white/20 shadow-xl relative overflow-hidden">
                    {/* Efeito de silhueta */}
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-gray-700/40 to-gray-900/60 rounded-full"></div>
                    <span className="text-4xl md:text-5xl lg:text-6xl opacity-60">👤</span>
                    
                    {/* Efeito de brilho animado */}
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent rounded-full animate-pulse"></div>
                  </div>
                  
                  <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-5 text-white/80">
                    Quem será o próximo?
                  </h2>
                  
                  <p className="text-base md:text-lg lg:text-xl opacity-90 font-light text-white/80 mb-5">
                ...
                <div className="bg-white/10 rounded-xl p-4 border border-white/20">
                  <div className="flex justify-center items-center gap-2">
                    ...
                    <span className="text-base md:text-lg lg:text-xl font-semibold text-white/90">Participe do próximo Kahoot!</span>
                    <span className="text-xl md:text-2xl animate-pulse delay-500">⚡</span>
                  </div>
                </div>
              </div>
            </div>
